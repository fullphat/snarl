...
Dim pn As Notification
    ...
    With pn
        .Title = "Feedback requested - sort of"
        .Text = "Click this or just let it time-out, it's cool either way..."
        .UID = "123456"
        .Class = "simpleclass"
...
Private Sub Form_Load()
    ...
    With myApp
        .Signature = "test/sfw_receiving_feedback"
