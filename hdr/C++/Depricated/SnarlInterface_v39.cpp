//-----------------------------------------------------------------------------
// NOTICE:
// This version of Snarl Interface is depricated!
// Use V41 interface files instead. The files can be found in Snarl SVN:
// \trunk\hdr\C++
//-----------------------------------------------------------------------------
...
// History
//  2010/08/13 : Moved to depricated status - Use the V41 API instead !
...
/// <returns>Message Id on success or M_RESULT on failure</returns>
/// LPCSTR Icon = NULL, HWND hWndReply = NULL, LONG32 uReplyMsg = 0, LPCSTR Sound = NULL);
LONG32 SnarlInterface::ShowNotification(LPCSTR Class, LPCSTR Title, LPCSTR Text, LONG32 Timeout, LPCSTR Icon /* = NULL */, HWND hWndReply /* = NULL */, LONG32 uReplyMsg /* = 0 */, LPCSTR Sound /* = NULL */)
{
	SNARLSTRUCTEX ssex;
