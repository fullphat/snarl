...
namespace Snarl.V42
{
    ...
    /// 
    /// <VersionHistory>
    /// 2011-12-09 : Added return comment for IsVisible - caller should check for Success.
    ...
    public class SnarlInterface
    {
        ...
        /// IsVisible
        /// </summary>
        /// <returns>SnarlStatus.Success if message is visible or in missed list - error code otherwise.</returns>
